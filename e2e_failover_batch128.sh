...
export FAILOVER_SLOWDOWN_THRESHOLD_SEC="${FAILOVER_SLOWDOWN_THRESHOLD_SEC:-30.0}"
export DEFAULT_VISIBLE_GPUS=0,1,2,3

export RUN_NOTE_BASE="${RUN_NOTE_BASE:-e2e_failover_batch128_40_60_2}"
...
SLOWDOWN_END_DEFAULT=$(( (EFFECTIVE_TOTAL_STEPS * SLOWDOWN_END_PCT) / 100 ))
